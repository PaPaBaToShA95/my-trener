...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4",
    ...
    >
      {children}
      <DialogPrimitive.Close className="focus-ring absolute right-4 top-4 rounded-full bg-muted/60 p-1 text-muted-foreground transition hover:bg-muted">
